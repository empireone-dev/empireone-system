import{r as n,c as j,l as v,u as N,j as t,s as k}from"./app-D5UpoGXt.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],D=p("x",L);async function R(s){try{return await j.post("/api/cocd_prompt",{prompt:s})}catch{}}function T(s){return async function(e,o){const r=await R(s.prompt);e(v.actions.setChatBots(r.data))}}function B(){const[s,e]=n.useState(!1),{chatbots:o}=N(a=>a.app),r=n.useRef(null),[d,l]=n.useState(!1),[x,c]=n.useState(!1),[u,m]=n.useState([{from:"bot",text:"Hello! How can I assist you today regarding the Code of Conduct and Discipline document?"}]),[i,f]=n.useState("");n.useEffect(()=>{const a=r.current;a&&(a.scrollTop=a.scrollHeight)},[u.length,s]);const h=()=>{s?(m([{from:"bot",text:"Hello! How can I assist you today?"}]),l(!1),setTimeout(()=>e(!1),300)):(e(!0),setTimeout(()=>l(!0),10))};console.log("chatbots",o.result),n.useEffect(()=>{o.result&&m(a=>[...a,{from:"bot",text:o.result}])},[o.result]);const y=async()=>{if(i.trim()!=="")try{c(!0),m([...u,{from:"user",text:i}]),f(""),await k.dispatch(T({prompt:i})),c(!1)}catch{f(""),c(!1)}};return t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:h,className:"fixed bottom-6 right-4",children:t.jsx("img",{src:"/gif/chatbot.gif",className:"h-24"})}),s&&t.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 backdrop-blur-sm transition-opacity",children:t.jsxs("div",{className:`bg-white h-screen w-screen max-w-none rounded-none 
