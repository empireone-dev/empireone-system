...
export default function CreatePettyCashSection() {
    ...
    const {
        ...
        defaultValues: {
            description: "",
            receipt_number: `PTC-${moment().format("YYYYMMDDHHmmss")}`,
            amount: "",
            tin: "N/A",
            files: [],
            date: dayjs(),
    ...
    async function submit_data(data) {
        ...
        formData.append("type", "Petty Cash");
    ...
    return (
        <>
            <Button onClick={() => setOpen(true)}>CREATE PETTY CASH</Button>
