...
export default function ExpensesDetailsSection() {
    const { expenses_reports, cash_flow } = useSelector(
        (state) => state.accounting
    );
    const { user } = useSelector((state) => state.accounts);
    const totalAmount = expenses_reports?.reduce(
    ...
    return (
        <>
            <div className=" rounded-t-lg px-4 py-8 shadow-xs ring-1 ring-gray-300 sm:mx-0  sm:px-8  lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-8 xl:pt-8 ">
                ...
                <dl className=" grid grid-cols-1 text-sm/6 sm:grid-cols-2">
